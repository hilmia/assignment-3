...
def is_cyrillic(uchr):
    try: return cyrillic_letters[uchr]
        ...
        return cyrillic_letters.setdefault(uchr, 'CYRILLIC' in unicodedata.name(unicode(uchr)))
...
def is_greek(uchr):
    try: return greek_letters[uchr]
        ...
        return greek_letters.setdefault(uchr, 'GREEK' in unicodedata.name(unicode(uchr)))
